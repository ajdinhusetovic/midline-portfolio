...
const Services = () => {
  return (
    <section className="py-20 px-6 bg-transparent h-full max-w-7xl mx-auto flex flex-col justify-center">
      <div className="max-w-7xl mx-auto text-center mb-12">
        <h2 className="text-7xl lg:text-9xl font-bold text-white mb-4">
          Our Services
        </h2>
      ...
      <div className="grid gap-8 md:grid-cols-1 lg:grid-cols-3 mx-auto mt-6">
