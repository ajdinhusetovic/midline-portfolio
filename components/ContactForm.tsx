          ...
          <div className="flex flex-col flex-1 overflow-y-auto mt-4">
            ...
            >
              <input
                ...
                required
                className="border-1 w-10/12 md:w-11/12 md:h-14 p-3 md:p-4 rounded font-semibold"
              />
              <input
                type="email"
                name="email"
              ...
              <textarea
                ...
                required
                className="border-1 resize-none w-10/12 md:w-11/12 h-40 lg:h-60 p-3 md:p-4 rounded font-semibold"
              />
              <motion.button
                type="submit"
                whileHover={{ scale: 1.1, transition: { duration: 0.1 } }}
                whileTap={{ scale: 0.9, transition: { duration: 0.1 } }}
                className="w-8/12 mx-auto px-6 py-3 lg:py-4 rounded text-lg md:text-2xl bg-blue-400 cursor-pointer text-white font-semibold hover:bg-blue-700 transition"
              >
                Get in Touch
              </motion.button>
            </form>
